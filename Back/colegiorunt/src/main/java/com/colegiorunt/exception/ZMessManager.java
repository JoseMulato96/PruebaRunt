package com.colegiorunt.exception;
...
public class ZMessManager extends RuntimeException {
	...
	public static String ENTITY_SUCCESFULLYSAVED = "registro guardado con exito";
	public static String ENTITY_SUCCESFULLYDELETED = "registro eliminado con exito";
	public static String ENTITY_SUCCESFULLYMODIFIED = "registro modificado con exito";
	public static String ENTITY_WITHSAMEKEY = "Ya existe un registro con este id";
